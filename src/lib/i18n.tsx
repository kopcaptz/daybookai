...
export const translations = {
  ...
  'ai.helperTitle': { ru: 'Помощник по экрану', en: 'Screen Helper', he: 'עזרה למסך', ar: 'مساعد الشاشة' },
  'ai.helperDisabledHint': { ru: 'Помощник по экрану сейчас недоступен. Полный чат остаётся в отдельной поверхности.', en: 'Screen Helper is unavailable right now. Full chat remains a separate surface.', he: 'עזרת המסך אינה זמינה כעת. הצ׳אט המלא נשאר במשטח נפרד.', ar: 'مساعد الشاشة غير متاح الآن. تبقى الدردشة الكاملة سطحًا منفصلاً.' },
  'ai.helperPlaceholder': { ru: 'Спросите про этот экран', en: 'Ask about this screen', he: 'שאל על המסך הזה', ar: 'اسأل عن هذه الشاشة' },
  'ai.helperStartConversation': { ru: 'Помогу с текущим экраном', en: 'I can help with this screen', he: 'אני יכול לעזור עם המסך הזה', ar: 'يمكنني المساعدة في هذه الشاشة' },
  'ai.helperStartConversationHint': { ru: 'Локальная помощь по текущему экрану. Для разговоров о записях используйте Discussions.', en: 'Local help for the current screen. Use Discussions for conversations about entries.', he: 'עזרה מקומית למסך הנוכחי. לשיחות על רשומות השתמש ב-Discussions.', ar: 'مساعدة محلية للشاشة الحالية. استخدم Discussions للمحادثات حول المدخلات.' },
