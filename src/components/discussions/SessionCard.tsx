  ...
  return (
    <div className="grimoire-card relative overflow-hidden group">
      ...
      >
        ...
        <ChevronRight className="h-4 w-4 text-muted-foreground/50 group-hover:text-cyber-sigil/70 group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 rtl:rotate-180 transition-all duration-200 shrink-0 mt-1" />
      </Link>
